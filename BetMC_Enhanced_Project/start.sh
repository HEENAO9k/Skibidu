...
echo -e "${BLUE}🌐 URL สำหรับเครื่องนี้: http://localhost:5000${NC}"
echo -e "${CYAN}🌍 เปิดให้คนอื่นเข้าถึงได้แล้ว!${NC}"
echo -e "${YELLOW}📱 กด Ctrl+C เพื่อหยุดเซิร์ฟเวอร์${NC}"
echo ""
echo -e "${YELLOW}⚠️  หมายเหตุ: ตรวจสอบ Firewall ของคุณ${NC}"
echo -e "${YELLOW}   อาจต้องเปิดพอร์ต 5000 ใน Firewall${NC}"
echo ""
